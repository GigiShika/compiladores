...
export const CONTENIDOS_MOCK = [
      ...
      area: AreaComputacion.TEORIA_COMPUTACION,
          ...
          contenido: [
      `# LIC. SARA MÉNDEZ GARCÍA`,
  `---`,
  `## Perfil Profesional`,
  `Licenciada en **Ciencias de la Informática**, egresada de la **UPIICSA** generación 1979 – 1983.`,
  ` `,
  `## Experiencia Laboral`,
  `* **Contabilidad:** Seis años de experiencia laboral en el área de contabilidad y finanzas.`,
  `* **Sistemas:** Dieciséis años de experiencia laboral en el Desarrollo de Sistemas de Información.`,
  `* **Docencia:** Veinte años de experiencia en el área docente en instituciones públicas y privadas.`,
  ` `,
